package eu.rtakacs.flyweight2;

public class SoldierImpl implements Soldier {

	/**
	 * Intrinsic State maintained by flyweight implementation Solider Shape ( graphical represetation) how to display
	 * the soldier is up to the flyweight implementation
	 */
	private Object soldierGraphicalRepresentation;

	/**
	 * Note that this method accepts soldier location 
	 * Soldier Location is Extrinsic and no reference to previous
	 * location or new location is maintained inside the flyweight implementation
	 */
